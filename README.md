...
DIY project to turn a regular LED grow light with a dumb controller into a smart one with a Raspberry Pi PicoW, which you can integrate to Home Assistant with ESPHome.
